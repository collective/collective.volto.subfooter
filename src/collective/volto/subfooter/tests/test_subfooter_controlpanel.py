...
class SubfooterServiceTest(unittest.TestCase):

    layer = VOLTO_SUBFOOTER_API_FUNCTIONAL_TESTING
    ...
    def setUp(self):
        ...
        self.controlpanel_url = "/@controlpanels/subfooter-settings"
    ...
    def test_controlpanel_listed(self):
        ...
        self.assertIn("Subfooter settings", titles)

    def test_route_exists(self):
        response = self.api_session.get("/@controlpanels/subfooter-settings")
...
class SubfooterServiceDeserializerTest(BaseTestWithFolders):
    ...
    def test_return_empty_dict_if_not_set(self):
        response = self.api_session.get("/@subfooter")
...
class SubfooterServiceSerializerTest(BaseTestWithFolders):
    ...
    def test_serializer_convert_linkUrl_from_uid_to_summary(self):
        ...
        result = json.loads(response.json()["data"]["subfooter_configuration"])
